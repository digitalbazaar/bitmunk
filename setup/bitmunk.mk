...
XPT_DIR = $(MO_DIST_DIR)/xpt
XPI_DIR = $(MO_DIST_DIR)/xpi
...
MO_LIBRARIES += $(patsubst %, $(MO_LIB_DIR)/$(LIB_PREFIX)%.$(DYNAMIC_LIB_EXT), $(COMPONENT_LIBRARIES))

ALL_GENERATED_HEADERS := $(patsubst %.idl, $(MO_BUILD_DIR)/%.h, $(IDL_SOURCES))
...
ALL_DIRECTORIES += $(MO_BUILD_DIR) $(MO_DIST_DIR) $(MO_LIB_DIR) $(MO_BIN_DIR) $(MO_MODULES_DIR) $(XPT_DIR) $(XPI_DIR)
