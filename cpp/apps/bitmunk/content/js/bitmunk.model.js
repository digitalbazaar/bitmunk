...
(function($)
{
    ...
    */
   bitmunk.model.addModel = function(model, inf)
   {
      inf = $.extend(inf,
      {
    ...
    */
   bitmunk.model.stop = function(task)
   {
    ...
    */
   bitmunk.model.attachView = function(task, model)
   {
    ...
    * @param model the name of the data model.
    */
   bitmunk.model.detachView = function(model)
   {
      // clear any stop timeout
      clearTimeout(sAvailableModels[model]);
    ...
    * }
    */
   bitmunk.model.addTable = function(task, options)
   {
      // create table info
      task.next(function(task)
      {
    ...
    *    }]
    */
   bitmunk.model.register = function(task, registerObject)
   {
      // initialize model
      task.next(function(task)
      {
    ...
    */
   bitmunk.model.unregister = function(task, model)
   {
    ...
    */
   bitmunk.model.update = function(model, table, id, row, seqNum)
   {
       var rval = false;
    ...
    */
   bitmunk.model.fetch = function(model, table, id)
   {
      var rval = null;
    ...
    */
   bitmunk.model.fetchAll = function(model, table)
   {
      var rval = null;
    ...
    *         registered.
    */
   bitmunk.model.slice = function(model, table, start, count)
   {
      var rval = null;
    ...
    * @param id the ID of the data row.
    */
   bitmunk.model.remove = function(model, table, id)
   {
    ...
    * @param table the name of the table.
    */
   bitmunk.model.clear = function(model, table)
   {
    ...
    * @param table the name of the table.
    */
   bitmunk.model.watch = function(model, table)
   {
