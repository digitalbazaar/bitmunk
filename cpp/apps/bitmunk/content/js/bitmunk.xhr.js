            ...
            var createCallHandler = function(f)
            {
               ...
               if($.browser.msie === true)
               {
                  ...
                  rval =
                     ...
                     'function(){bitmunk.xhr.requests[e.id].' + f + '(e);},' +
                     '0);}';
               }
               else
               {
                  rval =
                     'function(e){bitmunk.xhr.requests[e.id].' + f + '(e);}';
               }
         ...
         var request =
         {
            ...
            xhr:
            {
               ...
               open: function(method, url, async, user, password)
               {
                  ...
                  bitmunk.xhr.requests[id] = request;
               ...
               abort: function()
               {
                  ...
                  delete bitmunk.xhr.requests[hpmRequest.id];
            ...
            bodyEventReceived: function(e)
            {
               ...
               delete bitmunk.xhr.requests[e.id];
               var logFunction =
            ...
            timeoutEventReceived: function(e)
            {
               ...
               bitmunk.xhr.requests[e.id].handleNetworkError(e);
            },
