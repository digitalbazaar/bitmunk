...
(function($)
{
   ...
   var sScriptTask = bitmunk.resource.getScriptTask(
      'bitmunk.webui.MediaLibrary', 'medialibrary.view.js');
   ...
   bitmunk.medialibrary.view =
   {
       ...
       */
      setActivityIndicator: function(indicator, enable, message)
      {
         // set the message
         if(message)
         {
       ...
       */
      showBrowserLoading: function(enable)
      {
       ...
       */
      setButton: function(name, enabled, callback, data)
      {
         var button = $(name);
       ...
       */
      addBrowserRow: function(file, media, ware, scheme, status)
      {
         bitmunk.log.debug(
       ...
       */
      setWareStatus: function(wareId, status, type)
      {
       ...
       */
      setWarePayment: function(wareId, scheme)
      {
       ...
       */
      updateBrowserRow: function(wareId, file, ware, scheme)
      {
         bitmunk.log.debug(
            sLogCategory, 'updateBrowserRow', wareId, file, scheme);
         if(!file)
         {
       ...
       */
      deleteBrowserRow: function(wareId)
      {
       ...
       */
      setBrowserMessage: function(message)
      {
       ...
       */
      setPageControl: function(params)
      {
         // DEBUG: output
       ...
       */
      updateSelectAll: function(selectAll, selects)
      {
       ...
       */
      addWareFeedback: function(fileId, type, message)
      {
       ...
       * @param fileId the ware file ID.
       */
      clearWareFeedback: function(fileId)
      {
