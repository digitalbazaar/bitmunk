...
(function($)
{
   ...
   bitmunk.purchases.view =
   {
       ...
       */
      removePurchaseRow: function(dsId)
      {
         // DEBUG: output
       ...
       */
      setPurchaseStatus: function(dsId, status, type)
      {
       ...
       */
      setPurchaseProgress: function(dsId, progress)
      {
       ...
       */
      showPurchaseDialog: function(show)
      {
       ...
       */
      setPurchaseDialog: function(ds, accounts, feedback)
      {
         // DEBUG: output
       ...
       */
      enableBuyerPreferences: function(enable)
      {
         if(enable)
         {
            // enable input
       ...
       * @param dsId the download state ID.
       */
      downloadComplete: function(dsId)
      {
         // DEBUG: output
       ...
       * @param dsId the download state ID.
       */
      purchaseComplete: function(dsId)
      {
         // DEBUG: output
       ...
       */
      addPurchaseFeedback: function(dsId, type, message)
      {
       ...
       * @param dsId the download state ID.
       */
      clearPurchaseFeedback: function(dsId)
      {
